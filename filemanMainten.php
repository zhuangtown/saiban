...
<?php include('menubar.php'); ?>
 ...
 <table class="l-tbl">
            ...
            <TR>
                ...
                <TR> <th class="l-cellsec"><input type="submit" name="searchOk" value="サーチ" class="m-btn" ></th>
				<td class="l-cellsec"><a href="excel/ecceltest.php"><input type="button" name="searchOk"   value="Excel書類作成" class="m-btn" ></a></td>
				</TR>
...
?>
	<div class="list">
		<p>&nbsp;</p>
		<table><TR><TD><?php if($_POST['inpCustomer']=="00"){echo $_POST['oneYear']."--".$_POST['inpKind']; } else{echo $_POST['oneYear']."--".$_POST['inpCustomer']."の".$_POST['inpKind'];}?></TD></TR></table>
		<table class="l-tbl">
		    <colgroup>
		    <col width="2%">
			<col width="20%">
