...
<!--                <TD WIDTH="95%"></TD>------2013/03/13â¸èC------------------------------------->
    ...
    <form action=thsyssave.php method=post name=thsys>
        <div class="list">
            <h3 align="center">
            ...
            <table class="l-tbl">
                ...
                <col width="60%">
                <TR>
                    <TH class="l-cellsec">è¡îÔê≈</TH>
                    <TD class="l-cellodd"><input type="text" name="shz" style="width: 300" maxlength="225" >
                    </TD>
                </TR>
        ...
        <table class="l-tbl">
            ...
            <TR>
                <TD align=center><br>
                    <input type="submit" name="thsysck" value="ämîF">
                </TD>
            </TR>
        </table>
    </div>
