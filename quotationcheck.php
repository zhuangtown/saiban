...
<?php include('menubar.php'); ?>
	...
	<div class="list">
		<h3 align="center">
			...
			<span style="color: darkslategray">見積書一覧</span>
		</h3>
		<table class="l-tbl">
			<col width="20%">
			<col width="60%">
 ...
 <table class="l-tbl">
                ...
                <col width="60%">
				 <TR>
                    ...
                    <TD class="l-cellodd" style="font-size:18px;">見積書
                    </TD>
                </TR>
            <TR>
...
?>
	<div class="list">
		<p>&nbsp;</p>
		<table><TR><TD><?php if($_POST['inpCustomer']=="00"){echo $_POST['oneYear']."--"."見積書"; } else{echo $_POST['oneYear']."--".$_POST['inpCustomer']."の"."見積書";}?></TD></TR></table>
		<table class="l-tbl">
		    <colgroup>
		    <col width="2%">
			<col width="20%">
