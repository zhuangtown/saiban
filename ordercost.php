...
<?php include('menubar.php'); ?>
	...
	?>
	<form action=ordercost.php method=post>
 <table class="l-tbl">
                <col width="20%">
                <col width="60%">
				 <TR>
                    <TH class="l-cellsec">種類</TH>
                    <TD class="l-cellodd" style="font-size:18px;">注文書
                    </TD>
                </TR>
            <TR>
...
?>
	<div class="list">
		<p>&nbsp;</p>
		<table><TR><TD><?php if($_POST['inpCustomer']=="00"){echo $_POST['oneYear']."--"."注文書"; } else{echo $_POST['oneYear']."--".$_POST['inpCustomer']."の"."注文書";}?></TD></TR></table>
		<table class="l-tbl">
		    <colgroup>
		    <col width="2%">
			<col width="20%">
