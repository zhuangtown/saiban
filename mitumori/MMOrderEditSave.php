...
include_once 'MMOrderFormat.php';
//DBへ接続
$db=DBconnect();
...
$sql_order_save = "INSERT INTO `mitumo`(`saibanRes`, `workName`, `workContents`, `periodStart`, `periodEnd`, `payCondition`, `workPlace`, `yukokikan`,`goods`,`station`, `explanation`, `buildDate`) VALUES ('".$_POST["saibanRes"]."','".$_POST["workName"]."','".$_POST["workContents"]."','".$_POST["periodStart"]."','".$_POST["periodEnd"]."','".$_POST["payCondition"]."','".$_POST["workPlace"]."','".$_POST["yukokikan"]."','".$_POST["goods"]."','".$_POST["station"]."','".$_POST["explanation"]."','".date('Y-m-d')."')";
...
header("Location:MMOrderEditFinish.php?saibanRes=".$_POST["saibanRes"]);
?>