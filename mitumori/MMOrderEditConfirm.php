...
//戻るボタンを押す場合
if(isset($_POST["edit"])){
    require('MMOrderEdit.php');
    exit;
}
//保存ボタンを押す場合
if(isset($_POST["save"])){
    require('MMOrderEditSave.php');
    exit;
}
...
<body id="doc">
    ...
    <form action=MMOrderEditConfirm.php method=post name=order>
        <div class="list">
            <h3 align="center">
            ...
            <table class="l-tbl">
                ...
                <TR>
                    ...
                    <TD class="l-cellodd">
                    <?php if(isset($_POST['yukokikan'])){echo $_POST['yukokikan'];}?>
                    <input type="hidden" name="yukokikan" value="<?php echo $_POST['yukokikan']?>">
                    </TD>
                </TR>
                ...
                <TR>
                    ...
                    <TD class="l-cellodd">
                    <?php if(isset($_POST['goods'])){echo $_POST['goods'];}?>
                    <input type="hidden" name="goods" value="<?php echo $_POST['goods']?>">
                    </TD>
                </TR>
                <TR>
                    <TH class="l-cellsec">納入場所</TH>
                    <TD class="l-cellodd">
                    <?php if(isset($_POST['station'])){echo $_POST['station'];}?>
