...
if(isset($_POST['confirm'])){
    ...
    //バリデーションを通る場合、確認画面へ
    if($errorMsgs == ""){
        require('TmsOrderEditConfirm.php');
        exit;
    }
}
...
if (!($explanation = file_get_contents("../tyumonsyo/files/explanation.txt"))) {
    echo "ファイルが開けません。";
}
...
<!--                <TD WIDTH="95%"></TD>------2013/03/13改修------------------------------------->
    ...
    <form action=TmsOrderEdit.php method=post name=order>
        <div class="list">
            <h3 align="center">
            ...
            <table class="l-tbl">
                ...
                <TR>
                    ...
                    <TD class="l-cellodd">
<!--2013/03/11--修正--readonly
                    <input type="text" name="periodStart" value="<?php if(isset($_POST['periodStart'])){echo $_POST['periodStart'];}?>" readonly=true style="width: 100">
-->
                    <input type="text" name="periodStart" value="<?php if(isset($_POST['periodStart'])){echo $_POST['periodStart'];}?>" style="width: 95">
<!--2013/03/11--修正--readonly
                    <input type="button" onClick="wrtCalendar(event,this.form.periodStart,'yyyy/m/d');" style="background-image: url(calendar.gif); background-color:#ffffff; width:20px; height:20px; border:0; cursor:pointer;" value=" " name="Calendar">
-->
                    ...
                    ～
<!--2013/03/11--修正--readonly
                    <input type="text" name="periodEnd" value="<?php if(isset($_POST['periodEnd'])){echo $_POST['periodEnd'];}?>" readonly=true style="width: 100">
-->
                    <input type="text" name="periodEnd" value="<?php if(isset($_POST['periodEnd'])){echo $_POST['periodEnd'];}?>" style="width: 95">
 <!--2013/03/11--修正--readonly
                   <input type="button" onClick="wrtCalendar(event,this.form.periodEnd,'yyyy/m/d');" style="background-image: url(calendar.gif); background-color:#ffffff; width:20px; height:20px; border:0; cursor:pointer;" value=" " name="Calendar">
-->
