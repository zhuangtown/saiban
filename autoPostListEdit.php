...
if ($_POST["edit"]){
 ...
 "', manager ='".$manager."',email='".$email."',zip_code='".$zip_code."',position='".$position."',address='".$address.
...
<body id="doc">
	...
	<!-- ------------------------------------------------------------------------------------------------------------------- -->
			...
			<input type="submit" value="戻る"formaction="./autoPostList.php?delete=0" class="m-btn" >
		</div>
