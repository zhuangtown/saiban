...
<!--                    <TD WIDTH="5%"><IMG SRC='img/logo.png' BORDER='0'>----2013/03/14改修----->
    ...
    <form action=quotationsaiban.php method=post>
        <div class="list">
            <h3 align="center">
                <span style="color: darkslategray">見積書作成</span>
            </h3>
            <table class="l-tbl">
                <col width="20%">
                <col width="60%">
                <TR>
                    ...
                    <TD class="l-cellodd">見積書   <input type="submit" value="番号作成" name="submit" class="m-btn" />
                 </TD>
                </TR>
                <TR>
        ...
        if(isset($_POST['submit'])&isset($_POST['inpDepartment'])&isset($_POST['inpCustomer']))
        {
            ...
            <table class="l-tbl">
                ...
                <?php 
                //番号をつながる
                $saiban_kari="S".$row_Department[0].date("y").date("m").$row_Customer[0];
                //⇒SJISに変換
            ...
            <BR> <input type="submit" value="見積書作成" name="insert" class="m-btn" onclick=window.open('quotationEdit.php?saiban_res=<?php echo $saiban_res?>'); />
			<input type="submit" value="キャンセル"　formaction="./quotationsaiban.php" class="m-btn" >
